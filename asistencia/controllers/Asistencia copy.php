...
class Asistencia extends MX_Controller
{
  ...
  {
    parent::__construct();
    $this->load->model('M_asistencia','m_asistencia');
  }

  function index()
  {
    $rows_html = array();
    $rows_trab = $this->m_asistencia->listar_trabajadores(); //-> Listar_trabajadores
  ...
  function busqueda()
  {
    ...
    $fecInicio .= ' 00:00:00.000';
    $fecFin .=  ' 23:59:59.997';
    $rows = $this->m_asistencia->listar_asistencia_import($fecInicio, $fecFin, $nombres, $dni); //-> $fech_ini, $fech_fin, $personal='', $pers_cod = ''
  ...
  function reporte()
  {
    ...
    $fecha_fin = "$anio-$mes";
    $rows = $this->m_asistencia->listar_asistencia_reporte($fecha, $fecha_fin, $nombres, $dni );
